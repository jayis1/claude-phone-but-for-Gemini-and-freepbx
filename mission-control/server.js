...
app.post('/api/test-call', async (req, res) => {
  ...
  try {
    ...
    const response = await fetch(`${VOICE_APP_URL}/api/outbound-call`, {
      ...
      body: JSON.stringify({
        to: number,
        message: "This is a test call from Mission Control. Confirm that you can hear me and then give a status report on the current system health.",
        mode: 'conversation'
      })
    });
      ...
      <head>
        ...
        <style>
          ...
          * {margin: 0; padding: 0; box-sizing: border-box; }
          ...
          align-items: center;
          border-bottom: 1px solid var(--border);
          background: rgba(255,255,2.5.1.02);
          }
          .panel-content {
            padding: 1.25rem;
          flex: 1;
          ...
          .control-group {
            margin-top: 1rem;
          padding: 1rem;
          background: rgba(255,255,2.5.1.03);
          border-radius: 8px;
          border: 1px solid var(--border);
          }
          .slider-container {
          ...
          .btn-secondary:hover {background: rgba(255,255,2.5.1.05); }
        ...
        <div class="grid">
          ...
          <div class="panel">
            ...
            <div class="panel-content">
              ...
              <div style="background: rgba(255,255,2.5.1.03); padding: 0.75rem; border-radius: 8px; margin-bottom: 0.5rem; border: 1px solid var(--border);">
...
app.get('/api/update/check', async (req, res) => {
  try {
    ...
    const remoteRes = await fetch('https://raw.githubusercontent.com/jayis1/gemini-phone-but-for-Gemini-and-freepbx/main/mission-control/package.json');
