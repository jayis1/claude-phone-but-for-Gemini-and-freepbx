...
module.exports = function generateTopPage() {
  return `
  < !DOCTYPE html >
    <html>
      <head>
        <title>Mission Control - Top</title>
        <meta name="viewport" content="width=device-width, initial-scale=1">
          ...
          <body>
            ...
            <div class="terminal-container">
              <div id="top-output">Connecting to Top...</div>
          ...
          // Enhanced client-side ANSI to HTML converter
            ...
            if (data.success) {
                const container = document.getElementById('top-output');
            container.innerHTML = ansiToHtml(data.output);
              } else {
              document.getElementById('top-output').textContent = 'Error: ' + (data.error || 'Failed to fetch top');
              }
