...
# Usage: curl -sSL https://raw.githubusercontent.com/jayis1/claude-phone-but-for-Gemini-and-freepbx/WEEDsMARTIX1.1.8/install.sh | bash
...
main() {
  ...
  if [ -d "$INSTALL_DIR" ]; then
    ...
    git reset --hard WEEDsMARTIX1.1.8
